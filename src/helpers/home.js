...
const oompaStateReducer = (state, { type, payload }) => {
	switch (type) {
		case ACTIONS.UPDATE_OOMPA_STATE: 
			return { ...state, oompas: [ ...state.oompas, ...payload ] };
...
export {
	ACTIONS, getOompas, handleOompaDetails, handleScroll, initialState, oompaStateReducer, searchOompa 
};